...
const insertVideos = async () => {
  ...
  ("https://www.youtube.com/watch?v=iXuTu2U9l9o", "Les requins sont-ils des sérial killers ? (Vous allez être surpris)", "Les requins sont-ils des sérial killers ou des victimes de leur réputation ? Aujourd’hui, Jamy rétablit la vérité sur ces prédateurs", true),
  ("https://www.youtube.com/watch?v=9MGGAZyq1Mw", "🌊 Pourquoi la mer est-elle salée ?", "🏖️ Qui va à la plage cet été ? Après avoir vu cette vidéo, si l’un de vos proches boit la tasse... vous saurez lui expliquer pourquoi la mer est salée ! Et pourquoi elle n’a pas le même goût partout 🤓", true),
  ...
  ("https://www.youtube.com/watch?v=LBb3HWtEL64", "Les animaux les plus DANGEREUX du monde", "Prenez votre courage à deux mains, nous partons à l’aventure en terre hostile ! Nous vous présentons notre #TOP5 des animaux les plus dangereux de la monde !", true),
  ...
  ("https://www.youtube.com/watch?v=uS_FdlQTzDY", "3 MONSTRES DE LÉGENDE : mythes ou histoires vraies ?", "Le monstre du Loch Ness, le Yéti ou encore le Kraken... Des créatures devenues populaires grâce aux mystères qui les entourent. Découvrons ensemble la vérité qui se cache derrière ses mythes 🔎😉", true),
  ("https://www.youtube.com/watch?v=HqsP6U9FouY", "Comment estimer l’âge des DINOSAURES ? 🦕", "🦴 OSerez-vous me suivre parmi ces dinosaures dans #ChezJamy ? J’ai eu la chance de rentrer au Muséum national d’Histoire naturelle 🤓 Voici donc comment estimer l’âge des dinosaures.", true),
  ...
  ("https://www.youtube.com/watch?v=OBCH6rfPvnA", "5 choses à savoir sur les tornades, les typhons, les tempêtes et les cyclones ?", "Savez-vous comment les tempêtes se forment ? Pourquoi ont-elles des prénoms ?", true),
  ("https://www.youtube.com/watch?v=n7-9hIcxm6s", "5 Catastrophes naturelles qui pourraient vraiment nous arriver", "Dignes de certains films catastrophes, voici un #top5 des catastrophes naturelles qui pourraient vraiment se produire : éruptions solaires, supervolcans, mégatsunami 🌊🌊🌊... 🤓", true),
  ...
  ("https://www.youtube.com/watch?v=e1i4KGI5Ag0", "La Camargue", "Fred, Jamy et Sabine sont partis à la découverte de la Camargue.", true),
  ("https://www.youtube.com/watch?v=Sg4zYbaFYwE", "L’ascension du Mont-Blanc", "Fred et Jamy prennent la direction de Chamonix pour faire l’ascension du Mont-Blanc.", true),
